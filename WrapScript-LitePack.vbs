...
Function FinalWrap()
    ...
    CreateFolder DIR&"\ZipFolderTmp\"&LAB&ID&"\myCPU"
    CopyFolder   DIR&"\mycpu_verify\rtl\myCPU", DIR&"\ZipFolderTmp\"&LAB&ID&"\myCPU"
    CopyFile     DIR&"\mycpu_verify\run_vivado\"&PRJ&"\"&PRJ&".runs\impl_1\soc_lite_top.bit", DIR&"\ZipFolderTmp\"&LAB&ID
	FileRename   DIR&"\ZipFolderTmp\"&LAB&ID&"\soc_lite_top.bit", "myCPU.bit"
